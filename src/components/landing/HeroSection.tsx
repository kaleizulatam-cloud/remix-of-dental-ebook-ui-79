    ...
    <section className="relative pt-12 pb-0 overflow-hidden min-h-[calc(100vh-220px)]">
      ...
      <div className="absolute right-0 lg:right-[5%] xl:right-[10%] top-0 bottom-0 w-[45%] hidden lg:flex items-end justify-center overflow-visible">
        <img
          ...
          className="w-auto h-[90%] max-w-none object-contain object-bottom drop-shadow-2xl transition-transform duration-300 ease-out hover:scale-[1.03] cursor-pointer origin-bottom"
        />
      </div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-stretch min-h-[calc(100vh-280px)]">
          <div className="flex flex-col justify-center space-y-4 animate-fade-up bg-secondary/40 backdrop-blur-md rounded-2xl p-6 md:p-8 border border-primary/20">
