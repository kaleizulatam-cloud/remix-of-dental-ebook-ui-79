...
const HeroSection = () => {
  ...
  return (
    <section className="relative pt-20 pb-0 overflow-hidden min-h-[calc(100vh-80px)]">
      ...
      {/* Ebook Image - Absolute position within hero */}
      <div className="absolute right-[5%] xl:right-[10%] top-0 w-[35%] h-[140%] hidden lg:flex items-start justify-center pointer-events-none z-20">
        <img
          src={ebookCover}
          alt="Guía Clínica de Emergencia - Edema Pulmonar"
          className="w-auto h-full max-w-none object-contain object-top drop-shadow-2xl"
        />
      </div>
